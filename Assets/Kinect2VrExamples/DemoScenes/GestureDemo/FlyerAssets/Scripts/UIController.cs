...
namespace VRStandardAssets.Flyer
{
    ...
    {
        public UIFader m_IntroUI;     // Reference to the script that controls the fading of the intro UI.
        public UIFader m_OutroUI;     // Reference to the script that controls the fading of the outro UI.
        public Text m_TotalScore;     // The text component used to display the score for this session.
