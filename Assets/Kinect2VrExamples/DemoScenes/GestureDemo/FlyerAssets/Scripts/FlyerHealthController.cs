...
namespace VRStandardAssets.Flyer
{
    ...
    {
        public float m_StartingHealth = 100f;         // The amount of health the flyer starts with.
        public GameObject m_FlyerExplosionPrefab;     // A prefab of the flyer exploded into parts.
        public Image m_HealthBar;                     // Reference to the image used as a health bar.
        public AudioSource m_ExplosionAudio;          // Reference to the audio source used to play the explosion sound.
        public AudioSource m_ThrusterAudio;           // Reference to the audio source used to play the sound of the flyer engines.
        public GameObject[] m_FlyerUIGameObjects;     // All the gameobjects containing UI for the flyer (to be turned off on death).
        public Renderer[] m_FlyerRenderers;           // All the renderers for the flyer (to be turned off on death).
        public Collider[] m_FlyerColliders;           // All the colliders for the flyer (to be turned off on death).
