...
namespace VRStandardAssets.Flyer
{
    ...
    {
        public int m_GameDuration = 30;                                   // The duration of the game
        public float m_IntroOutroFadeDuration = 0.5f;                     // The duration of the fade before and after the intro
        //public SelectionSlider m_SelectionSlider;                         // The slider needed to start the game.
        public Reticle m_Reticle;                                         // The reticle so it can be turned on to aim at the selection slider.
        public FlyerHealthController m_HealthController;                  // The flyer's health so it can be reset.
        public FlyerAlignmentChecker m_AlignmentChecker;                  // The script to check ring alignments, it should only be on whilst the game runs.
        public FlyerMovementController m_FlyerMovementController;         // The script controlling the movement of the flyer.
        public EnvironmentController m_EnvironmentController;             // This needs to know when to start and stop spawning the environment.
        public UIController m_UIController;                               // This needs to know when specific pieces of UI should be shown.
//        public GUIArrows m_GuiArrows;                                     // The GUI Arrows shown at the start.
        public Image m_TimerBar;                                          // Timer slider to indicate time remaining.
//        public InputWarnings m_InputWarnings;                             // This needs to know when to show different warnings.
        public VRCameraFade m_CameraFade;                                 // This is used to fade out and back in again as the game starts.
        public SelectionRadial m_SelectionRadial;                         // Used to restart the game.
