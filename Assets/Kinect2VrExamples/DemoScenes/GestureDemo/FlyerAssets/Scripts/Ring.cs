...
namespace VRStandardAssets.Flyer
{
    ...
    public class Ring : MonoBehaviour
    {
        ...
        public int m_Score = 100;                         // The amount added to the player's score when the ring is activated.
        public AudioSource m_AudioSource;                 // Reference to the audio source that plays a clip when the player activates the ring.
        public Color m_BaseColor = Color.blue;            // The colour the ring is by defalt.
        public Color m_ShipAlignedColor = Color.yellow;   // The colour the ring is when the ship is aligned with it.
        public Color m_ActivatedColor = Color.green;      // The colour the ring is when it has been activated.
