...
namespace VRStandardAssets.Flyer
{
    ...
    public class Asteroid : MonoBehaviour
    {
        ...
        public float m_AsteroidMinSize = 10f;     // The minimum amount an asteroid can be scaled up.
        public float m_AsteroidMaxSize = 20f;     // The maximum amount an asteroid can be scaled up.
        public float m_MinSpeed = 0f;             // The minimum speed the asteroid will move towards the camera.
        public float m_MaxSpeed = 10f;            // The maximum speed the asteroid will move towards the camera.
        public float m_MinRotationSpeed = 100f;   // The minimum speed the asteroid will rotate at.
        public float m_MaxRotationSpeed = 140f;   // The maximum speed the asteroid will rotate at.
        public int m_PlayerDamage = 20;           // The amount of damage the asteroid will do to the ship if it hits.
        public int m_Score = 10;                  // The amount added to the score when the asteroid hits either the ship or a laser.
