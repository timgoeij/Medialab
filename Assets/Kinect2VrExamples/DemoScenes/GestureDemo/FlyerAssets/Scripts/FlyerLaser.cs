...
namespace VRStandardAssets.Flyer
{
    ...
    {
        public float m_Speed = 500f;              // The speed each laser moves forward at.
        public float m_LaserLifeDuration = 3f;    // How long the laser lasts before it's returned to it's object pool.
