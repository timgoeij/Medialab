...
namespace VRStandardAssets.Flyer
{
    ...
    {
        public float m_AsteroidSpawnFrequency = 3f;       // The time between asteroids spawning in seconds.
        public float m_RingSpawnFrequency = 10f;          // The time between rings spawning in seconds.
        public int m_InitialAsteroidCount = 10;           // The number of asteroids present at the start.
        public float m_AsteroidSpawnZoneRadius = 120f;    // The radius of the sphere in which the asteroids spawn.
        public float m_RingSpawnZoneRadius = 50f;         // The radius of the sphere in which the rings spawn.
        public float m_SpawnZoneDistance = 500f;          // The distance from the camera of the spawn spheres.
        public ObjectPool m_AsteroidObjectPool;           // The object pool that stores the asteroids.
        public ObjectPool m_AsteroidExplosionObjectPool;  // The object pool that stores the expolosions made when asteroids are hit.
        public ObjectPool m_RingObjectPool;               // The object pool that stores the rings.
        public Transform m_Cam;                           // Reference to the camera's position.
